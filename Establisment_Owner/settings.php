                  ...
                  <div class="subs-box w-row">
                    <div class="subscribe-now w-col w-col-6">
                      ...
                      <div class="subscription-type">
                        ...
                        <select class="dropdown-toggle w-dropdown-toggle" name="subscription" id="subscribe">
                          <option value="volvo">59P / Month</option>
                          <option value="saab">234Php/ Yearly</option>
                        </select>
            ...
            <div class="form-block w-form">
              ...
              <form id="email-form" name="email-form" data-name="Email Form" method="POST" enctype="multipart/form-data">
                ...
                <div class="content-center">
                  <input type="submit" name="approve" value="Update Business Information" data-wait="Please wait..." class="primary-button setting-btn w-button">
                </div>
              </form>
